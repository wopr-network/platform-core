      ...
      <div className="mt-8 space-y-8 text-sm leading-relaxed text-muted-foreground">
        ...
        <section id="section-2" className="scroll-mt-16">
          ...
          <p>
            ...
            providers (the &ldquo;bring your own key&rdquo; model). WOPR Bot manages orchestration,
            memory, plugins, and channel integrations. The service is available at wopr.bot.
          </p>
          <p className="mt-2">
            WOPR Bot does not provide AI models directly. We orchestrate your interactions with your
            chosen AI providers using your API keys. Additionally, we offer optional hosted
        ...
        <section id="section-4" className="scroll-mt-16">
          ...
          <ul className="ml-4 mt-2 list-disc space-y-1">
            <li>
              Hosted capability credits are consumed on a per-use basis and are non-refundable once
              consumed.
            </li>
            <li>
              Upgrades and downgrades take effect immediately. When upgrading, you will be charged a
              prorated amount for the remainder of the billing period.
            </li>
            <li>
        ...
        <section id="section-5" className="scroll-mt-16">
          ...
          <p className="mt-2">
            We may suspend or terminate your account for violations of these terms. Where possible,
            we will provide notice before suspension. For serious violations (abuse, fraud, illegal
            activity), we reserve the right to terminate immediately without notice.
          </p>
        </section>
        ...
        <section id="section-8" className="scroll-mt-16">
          ...
          <ul className="ml-4 mt-2 list-disc space-y-1">
            <li>
              You retain ownership of your content, including bot configurations, prompts, and data
              you provide to the service.
            </li>
            <li>
              You grant WOPR Bot a limited, non-exclusive license to process your content solely for
            ...
            <li>
              AI-generated outputs belong to you, subject to the terms of service of your chosen AI
              provider. WOPR Bot makes no claims to AI-generated content.
            </li>
          </ul>
        </section>
        ...
        <section id="section-9" className="scroll-mt-16">
          ...
          <ul className="ml-4 mt-2 list-disc space-y-1">
            ...
            <li>
              WOPR Bot is not liable for charges from your AI providers, including charges resulting
              from bot activity you have configured.
            </li>
            <li>
        ...
        <section id="section-11" className="scroll-mt-16">
          ...
          <p className="mt-2">
            ...
            shall not exceed the amount you paid to WOPR Bot in the 12 months preceding the claim.
            We are not liable for actions taken by AI providers or for AI-generated content.
          </p>
        </section>
        ...
        <section id="section-12" className="scroll-mt-16">
          ...
          <p>
            You agree to indemnify, defend, and hold harmless WOPR Network, its officers, directors,
            employees, and agents from and against any claims, liabilities, damages, losses, and
            expenses (including reasonable attorneys&apos; fees) arising out of or in any way
            connected with your use of the service, your content, or your violation of these terms.
          </p>
        </section>
        ...
        <section id="section-15" className="scroll-mt-16">
          ...
          <p>
            ...
            will notify you at least 30 days in advance via email or through a prominent notice on
            the service. Your continued use of WOPR Bot after the updated terms take effect
