      ...
      <div className="mt-8 space-y-8 text-sm leading-relaxed text-muted-foreground">
        <section id="section-1" className="scroll-mt-16">
          ...
          <p>
            ...
            &ldquo;our&rdquo;) is the data controller responsible for your personal data. We operate
            the WOPR Bot platform available at wopr.bot.
          </p>
          <p className="mt-2">
        ...
        <section id="section-2" className="scroll-mt-16">
          ...
          <p>
            We only collect information that is necessary to provide and improve WOPR Bot services.
            We do not collect data for advertising or sell your information to third parties.
          </p>
          ...
          <p>
            Plugin selections, channel configurations, provider settings, and other choices you make
            while setting up and operating your bots. This data is necessary to deliver the service
            as you have configured it. Legal basis: performance of our contract with you.
          </p>

          <h3 className="mb-1 mt-4 text-sm font-semibold text-foreground">Usage data</h3>
          <p>
            API call counts, feature usage metrics, and hosted capability credit consumption. We use
            this data for billing, capacity planning, and service improvement. Legal basis:
          ...
          <p>
            ...
            this for security monitoring, abuse prevention, and debugging. Server logs are retained
            for 90 days. Legal basis: legitimate interest in securing our service.
          </p>
        </section>
        ...
        <section id="section-3" className="scroll-mt-16">
          ...
          <p>
            ...
            cookies. We share data with the following categories of sub-processors only as needed to
            provide the service:
          </p>
          <ul className="ml-4 mt-2 list-disc space-y-1">
            ...
            <li>
              <span className="text-foreground">Hosting provider</span> &mdash; infrastructure. Our
              servers and Docker fleet are hosted by third-party infrastructure providers who may
            ...
            <li>
              ...
              We use a third-party email service to send password resets, billing notifications, and
              other operational messages.
            </li>
          </ul>
          <p className="mt-2">
            We may also disclose information if required by law, to enforce our Terms of Service, or
            to protect the rights, property, or safety of WOPR Network, our users, or the public.
          </p>
        </section>
        ...
        <section id="section-6" className="scroll-mt-16">
          ...
          <ul className="ml-4 mt-2 list-disc space-y-1">
            <li>
              Billing and transaction records are retained for up to 7 years as required by tax and
        ...
        <section id="section-7" className="scroll-mt-16">
          ...
          <p>
            We use essential cookies only. These cookies are required for authentication and session
            management (powered by better-auth) and cannot be disabled without breaking the service.
            We do not use marketing cookies, analytics cookies, or third-party tracking pixels.
            There is no cookie banner because there is nothing optional to consent to.
          </p>
        </section>
        ...
        <section id="section-10" className="scroll-mt-16">
          ...
          <p>
            ...
            freedoms, we will notify affected users without undue delay. Where required by GDPR, we
            will also notify the relevant supervisory authority within 72 hours of becoming aware of
            the breach.
          </p>
        </section>
        ...
        <section id="section-12" className="scroll-mt-16">
          ...
          <p>
            ...
            will notify you by email or through a prominent notice on the service before the changes
            take effect. Your continued use of WOPR Bot after the changes take effect constitutes
