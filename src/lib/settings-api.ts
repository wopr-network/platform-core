...
const settingsClient = (trpcVanilla as unknown as { settings: SettingsProcedures }).settings;
const capabilitiesClient = (trpcVanilla as unknown as { capabilities: CapabilitiesProcedures })
  .capabilities;
